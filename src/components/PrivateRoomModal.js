...
export default function PrivateRoomModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md transition-all animate-in fade-in duration-200">
      <div className={`relative w-full max-w-lg bg-gradient-to-b from-[#0b1c15] via-[#071510] to-[#040c08] border border-[#d4be8c]/25 shadow-[0_25px_80px_rgba(0,0,0,0.9),0_0_60px_rgba(18,64,50,0.35)] rounded-3xl p-6 sm:p-8 max-h-[92vh] overflow-y-auto text-white selection:bg-[#d4be8c] selection:text-black ${inter.className}`}>
